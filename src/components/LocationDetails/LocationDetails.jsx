...
const LocationDetails = ({ locationId, location_details, visited_locations, onModalLocationsChanged, onHandleChildCloseModal }) => {
                  ...
                  <div className="relative space-y-4">
                    <div className='relative flex'>
                      <div className="flex flex-col space-y-2 w-3/5 ">
                        ...
                        <div className="mb-0 text-lg text-gray-400 w-3/4 leading-5">Beyond fear, vampires awaits.</div>
                      </div>
                      <div className='w-2/5 flex justify-around items-center'>
                        <button className="bg-white hover:bg-gray-200 text-black text-center py-1 px-1 rounded-full h-12 w-12 inline-flex items-center justify-center">
                          <TbMapSearch className='text-2xl' />
                        </button>
                        <button
                          className="bg-white hover:bg-gray-200 text-black text-center py-1 px-1 rounded-full h-12 w-12 inline-flex items-center justify-center"
                          onClick={
                            () => {
                          ...
                          {check ? 
                            ...
                            :
                            <RiCloseFill className='text-2xl scale-150' />
                            }
                        </button>
                      </div>
                    </div>
