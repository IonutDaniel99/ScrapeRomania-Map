...
const LocationDetailsModal = ({
  ...
  location_details,
  visited_locations,
  onModalLocationsChanged,
  onHandleChildCloseModal,
}) => {
  ...
  const checkForType = (location_details) => {
    ...
    if (isRoad !== undefined) {
      return (
        <>
          <div className="text-sm text-gray-400 w-18 text-center">
            Distance:
          </div>
    ...
    return (
      <>
        ...
        <div className="release">
          {location_details.surface} km<sup>2</sup>
        </div>
      </>
    );
  };
  ...
  return (
    <>
      <div className="absolute w-full min-h-[28rem] max-w-sm shadow-lg rounded-lg overflow-hidden z-50 sm:top-20 sm:left-10 sm:w-96 my-4">
        <img
          className="absolute inset-0 transform w-[400px] h-[600px] object-cover -translate-y-4 grayscale-0"
          src={`/images/locations_images/${location_details.image_url}.jpg`}
          alt={location_details.name}
        />
            ...
            <div className="relative  group z-10 px-10 pt-10 space-y-6">
              <div className="align-self-end w-full">
                <div className="absolute inset-x-0 top-0 pt-5 w-full mx-auto text-2xl uppercase text-center drop-shadow-sm font-bold text-white">
                  <span className="bg-black bg-opacity-40 px-2 shadow-stone-900 rounded-tl-lg rounded-br-lg">
                ...
                <div className="relative space-y-2">
                  <div className="relative flex">
                    ...
                    <div className="flex justify-end w-2/6 gap-2 items-center top-1 relative">
                      <button
                        ...
                        onClick={() => {
                          openInNewTab(
                            location_details.coords.lat,
                            location_details.coords.long
                          );
                        }}
                      >
                  ...
                  <div className="flex flex-row justify-between pb-8">
                    ...
                    <div className="flex flex-col  items-center w-20">
                      ...
                      <div className="popularity flex items-center justify-between w-20">
                        {checkForDecimalAfterDor(location_details.popularity)}
                        <span>/</span>
                        <span className={"flex items-center"}>
                          10 <StarIcon fontSize={"small"} />
                        </span>
                      </div>
                    </div>
                    <div className="flex flex-col  items-center w-20">
                      ...
                      <div className="release">
                        ~{location_details.visit_time} Hrs
                      </div>
                    </div>
                  </div>
                </div>
