    ...
    return (
        <>
            <div className="
                ...
                ">
                <img className="absolute inset-0 transform w-[400px] h-[600px] object-cover -translate-y-4 grayscale-0" src={`/images/locations_images/${location_details.image_url}.jpg`} />
