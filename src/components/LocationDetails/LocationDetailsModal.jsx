                ...
                <div className='relative space-y-2'>
                  <div className='relative flex'>
                    ...
                    <div className='flex justify-end w-2/6 gap-2 items-center top-1 relative'>
                      ...
                      >
                        {check ? <FaCheck className='text-xl' /> : <RiCloseFill className='text-xl scale-150' />}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className='flex flex-row justify-between pb-8'>
                    <div className='flex flex-col items-center w-20 '>{checkForType(location_details)}</div>
